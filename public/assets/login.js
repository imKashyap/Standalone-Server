...
(function dartProgram() {
  ...
  D = {SourceLocationMixin: function SourceLocationMixin() {
    ...
    main: function(args) {
      var t1 = J.get$onClick$x(document.querySelector(".btn")),
        t2 = t1.$ti;
      t2._eval$1("~(1)?")._as(D.login__submitHandler$closure());
      type$.nullable_void_Function._as(null);
      W._EventStreamSubscription$(t1._target, t1._eventType, D.login__submitHandler$closure(), false, t2._precomputed1);
    },
    submitHandler: function($event) {
      return D.submitHandler$body(type$.legacy_MouseEvent._as($event));
    },
  ...
  (function installTearOffs() {
    ...
    _static_1(D, "login__submitHandler$closure", "submitHandler", 36);
  })();
